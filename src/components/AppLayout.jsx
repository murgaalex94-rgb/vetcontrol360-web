...
var menuConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/facturacion', label: 'Finanzas', icono: 'M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 0 4.5 6h.75m13.5 0h.75a.75.75 0 0 0 .75-.75V4.5m-15 0v16.5a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5V4.5', roles: [ROL_ADMIN, ROL_VETERINARIO, ROL_ASISTENTE] },
    ],
  },
  {
    titulo: 'SISTEMA',
...
41:       { to: '/sunat', label: 'Fact. Electrónica', icono: 'M12 21v-6m0 0-3 3m3-3 3 3M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 5.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v14.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V5.625Z', roles: [ROL_ADMIN, ROL_VETERINARIO] },
    ],
  },
];
