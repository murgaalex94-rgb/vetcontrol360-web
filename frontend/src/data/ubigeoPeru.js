const ubigeoPeru = {
  "Amazonas": {
    ...
    "Luya": ["Lamud", "Camporredondo", "Cocabamba", "Colcamar", "Conila", "Inguilpata", "Longuita", "Lonya Chico", "Luya", "Luya Viejo", "María", "Ocalli", "Ocumal", "Pisuquía", "Providencia", "San Cristóbal", "San Francisco del Yeso", "San Jerónimo", "San Juan de Lopecancha", "Santa Catalina", "Santo Tomas", "Tingo", "Trita"],
  ...
  "Áncash": {
    ...
    "Huari": ["Huari", "Anra", "Cajay", "Chavín de Huántar", "Huacachi", "Huacchis", "Huachis", "Huántar", "Masin", "Paucas", "Ponto", "Rahuapampa", "Rapayán", "San Marcos", "San Pedro de Chana", "Uco"],
    ...
    "Mariscal Luzuriaga": ["Piscobamba", "Casca", "Eleazar Guzmán Barron", "Fidel Olivas Escudero", "Llama", "Llumpa", "Lucma", "Musga", "Ocros"],
  ...
  "Apurímac": {
    ...
    "Andahuaylas": ["Andahuaylas", "Andarapa", "Chiara", "Huancarama", "Huancaray", "Huayana", "José María Arguedas", "Kaquiabamba", "Kishuara", "Pacobamba", "Pacucha", "Pampachiri", "San Antonio de Cachi", "San Jerónimo", "Santa María de Chicmo", "Talavera", "Tumay Huaraca", "Turpo"],
  ...
  "Arequipa": {
    ...
    "Caylloma": ["Chivay", "Achoma", "Cabanaconde", "Callalli", "Coporaque", "Huambo", "Huanca", "Ichupampa", "Lari", "Lluta", "Maca", "Madrigal", "Majás", "San Antonio de Chuca", "Sibayo", "Tapay", "Tisco", "Tuti", "Yanque"],
  ...
  "Cajamarca": {
    ...
    "Celendín": ["Celendín", "Chumuch", "Cortegana", "Huasmín", "Jorge Chávez", "José Gálvez", "Miguel Iglesias", "Oxamarca", "Sorochuco", "Sucre", "Utco"],
    ...
    "San Marcos": ["Pedro Gálvez", "Chancay", "Eduardo Villanueva", "Gregorio Pita", "Ichocán", "José Manuel Quiroz", "José Sabogal", "San Marcos"],
    "San Miguel": ["San Miguel", "Bolívar", "Calquis", "Catilluc", "El Porvenir", "Huacllas", "La Florida", "Llapa", "Nanchoc", "Niepos", "San Gregorio", "San Silvestre de Cochán", "Tongod", "Unión Agua Blanca"],
  ...
  "Cusco": {
    ...
    "La Convención": ["Quillabamba", "Echarati", "Huayopata", "Maranura", "Ocobamba", "Santa Teresa", "Vilcabamba", "Pichari", "Inkawasi", "Villa Virgen", "Villa Kintiarina", "Megantoni"],
  ...
  "Huancavelica": {
    ...
    "Tayacaja": ["Pampas", "Acostambo", "Acraquia", "Ahuaycha", "Colcabamba", "Daniel Hernández", "Huachocolpa", "Huaribamba", "Ñahuimpuquio", "Pazos", "Salcabamba", "Salcahuasi", "San Marcos de Rocchac", "Surcubamba", "Tintay Puncu", "Quishuar", "Roble", "Santiago de Tucuma"]
  },
  "Huánuco": {
    "Huánuco": ["Huánuco", "Amarilis", "Chinchao", "Churubamba", "Margos", "Pillco Marca", "Quisqui", "San Francisco de Cayrán", "San Pedro de Chaulán", "Santa María del Valle", "Yacus", "Yarumayo"],
    ...
    "Leoncio Prado": ["Tingo María", "Castillo Grande", "Daniel Alomía Robles", "Hermilio Valdizán", "José Crespo y Castillo", "Luyando", "Mariano Dámaso Beraun", "Rupa-Rupa"],
    ...
    "Yarowilca": ["Chavinillo", "Cahuac", "Chacabamba", "Chupan", "Jacas Chico", "Obas", "Pampamarca", "San Francisco de Asís"]
  },
  "Ica": {
  ...
  "Junín": {
    "Huancayo": ["Huancayo", "Carhuacallanga", "Chacapampa", "Chicche", "Chilca", "Chongos Alto", "Chupuro", "Colca", "Cullhuas", "El Tambo", "Huacrapuquio", "Hualhuas", "Huancán", "Huasicancha", "Huayucachi", "Ingenio", "Pariahuanca", "Pilcomayo", "Pucará", "Quichuay", "Quilcas", "San Agustín de Cajas", "San Jerónimo de Tunán", "Saño", "Santo Domingo de Acobamba", "Sicaya", "Viques"],
    "Concepción": ["Concepción", "Ácobamba", "Andamarca", "Chambara", "Cochas", "Comas", "Heroínas Toledo", "Manzanares", "Mariscal Castilla", "Matahuasi", "Mito", "Nueve de Julio", "Orcotuna", "San José de Quero", "Santa Rosa de Ocopa"],
    "Chanchamayo": ["Chanchamayo", "Perené", "Pichanaqui", "San Luis de Shuaro", "San Ramón", "Vitoc"],
    "Jauja": ["Jauja", "Acolla", "Apata", "Ataura", "Canchayllo", "Curicaca", "El Mantaro", "Huamalí", "Huaripampa", "Huertas", "Janjaillo", "Julcán", "Leonor Ordóñez", "Llocllapampa", "Marco", "Masma", "Masma Chicche", "Molinos", "Monobamba", "Muqui", "Muquiyauyo", "Paca", "Paccha", "Pancan", "Parco", "Pomacancha", "Ricrán", "San Lorenzo", "San Pedro de Chunán", "Sincos", "Tunanmarca", "Yauyos"],
  ...
  "Lambayeque": {
    "Chiclayo": ["Chiclayo", "Chongoyape", "Eten", "Eten Puerto", "José Leonardo Ortiz", "La Victoria", "Lagunas", "Monsefú", "Nueva Arequipa", "Oyotún", "Patapo", "Picsi", "Pimentel", "Pomalca", "Pucalá", "Reque", "Saña", "Santa Rosa", "Tumán"],
  ...
  "Lima": {
    "Lima": ["Miraflores", "San Isidro", "Barranco", "Santiago de Surco", "San Borja", "La Molina", "San Miguel", "Magdalena del Mar", "Jesús María", "Lince", "Pueblo Libre", "San Juan de Miraflores", "Villa María del Triunfo", "Villa El Salvador", "Los Olivos", "San Martín de Porres", "Comas", "Independencia", "Carabayllo", "Puente Piedra", "Ancón", "Santa Rosa", "Cieneguilla", "Chaclacayo", "Lurigancho", "Ate", "El Agustino", "San Juan de Lurigancho", "Breña", "Rímac", "Cercado de Lima", "Chorrillos", "Surquillo", "Santa Anita", "San Luis", "San Bartolo", "Punta Hermosa", "Punta Negra", "Pucusana", "Lurín", "Pachacámac"],
  ...
  "Loreto": {
    "Maynas": ["Iquitos", "Alto Nanay", "Fernando Lores", "Indiana", "Las Amazonas", "Mazán", "Napo", "Punchana", "San Juan Bautista", "Torres Causana", "Belen"],
    "Alto Amazonas": ["Yurimaguas", "Balsapuerto", "Jeberos", "Lagunas", "San Jerónimo", "Santa Cruz", "Teniente César López Rojas"],
    ...
    "Mariscal Ramón Castilla": ["Caballococha", "Benjamin Constant", "Javier Rojo Gómez", "Ramon Castilla", "San Pablo"],
    "Putumayo": ["Putumayo", "Rosa Panduro", "Teniente Mantilla", "Yaguas"],
  ...
  "Moquegua": {
    ...
    "General Sánchez Cerro": ["Omate", "Chojata", "Coalaque", "Ichuña", "La Capilla", "Lloque", "Matalaque", "Puquina", "Quinistacas", "Ubinas", "Yunga"],
  ...
  "Piura": {
    "Piura": ["Piura", "Castilla", "Catacaos", "Cura Mori", "El Tallán", "La Arena", "La Unión", "Las Lomas", "Tambo Grande", "Vice"],
    "Ayabaca": ["Ayabaca", "Frías", "Jilili", "Lagunas", "Montero", "Pacaipampa", "Paimas", "Sapillica", "Sícchez", "Suyo"],
  ...
  "San Martín": {
    ...
    "Huallaga": ["Saposoa", "Altamira", "El Eslabón", "Piscoyacu", "Sacanche", "Tingo de Saposoa"],
    ...
    "Mariscal Cáceres": ["Juanjuí", "Campanilla", "Huicungo", "Pachiza", "Pajaten"],
  ...
  "Tacna": {
    "Tacna": ["Tacna", "Alto de la Alianza", "Calana", "Ciudad Nueva", "Coronel Gregorio Albarracín", "Inclán", "La Yarada los Palos", "Pachía", "Palca", "Pocollay", "Sama"],
  ...
  "Ucayali": {
    ...
    "Padre Abad": ["Aguaytía", "Curimaná", "Neshuya", "Alexander von Humboldt", "Irazola"],
    "Purús": ["Purús"]
  }
};
